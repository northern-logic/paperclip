...
Optional fields:
- profile (string): explicit Hermes profile for skill inventory and reconciliation; defaults to default.
...
- skillBridgeBaseUrl (string): private Northern Logic skill-bundle bridge URL.
- skillBridgeCredential (string): bearer credential for the bundle bridge.
