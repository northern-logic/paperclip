  ...
  return {
    fields: [
      ...
      },
      {
        ...
        type: "text",
        default: "default",
        hint: "Explicit Hermes profile whose skills and instruction files Paperclip manages.",
      },
      {
        key: "managementBaseUrl",
        label: "Dashboard management URL",
        type: "text",
        hint: "Private URL for the stock Hermes dashboard/control service, usually the tunnel to port 9119.",
      },
      {
        key: "managementCredential",
        label: "Dashboard management credential",
        type: "text",
        hint: "Value of HERMES_DASHBOARD_SESSION_TOKEN. Stored as a Paperclip secret reference and never sent to the browser.",
        meta: { secret: true },
      },
      {
        key: "skillBridgeBaseUrl",
        label: "Profile management bridge URL",
        type: "text",
        hint: "Private URL for the Northern Logic v1 profile-management bridge on the Hermes VM. It serves skills and the allowlisted instruction files.",
      },
      {
        key: "skillBridgeCredential",
        label: "Profile management bridge credential",
        type: "text",
        hint: "Bearer credential for the Northern Logic profile-management bridge. Stored as a Paperclip secret reference.",
        meta: { secret: true },
      },
      {
        key: "skillManagementTimeoutMs",
        label: "Profile management timeout ms",
        type: "number",
        default: 10000,
        hint: "Deadline for each dashboard or bundle-bridge request.",
      },
      {
